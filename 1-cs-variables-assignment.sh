...
# - As an alternative, you can run the parameters giving the first three parameters (CID, CrowdStrike Cloud Region and API Client ID); in this case the script will just ask you for the API Client Secret
